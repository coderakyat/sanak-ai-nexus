      ...
      <div className="container-edge mx-auto max-w-[1600px] py-20 md:py-28">
        <div className="grid gap-16 md:grid-cols-12">
          <div className="md:col-span-6">
            ...
            <h2 className="mt-6 font-display text-4xl leading-[0.95] md:text-5xl lg:text-6xl text-[color:var(--color-graphite-300)]">
          ...
          <div className="grid grid-cols-2 gap-10 md:col-span-6 md:grid-cols-3">
            <div>
              ...
              <ul className="mt-5 space-y-3 text-sm text-[color:var(--color-graphite-300)]">
            ...
            <div>
              ...
              <ul className="mt-5 space-y-3 text-sm text-[color:var(--color-graphite-300)]">
                ...
                <li className="text-[color:var(--color-graphite-500)]">Malaysia · Singapore</li>
              </ul>
            </div>
          </div>
        </div>
